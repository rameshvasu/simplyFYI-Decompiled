...
// Type: RameshInnovation.VoiShare.OfficeLive.DataAccess.FYIDataAccessShadow
// Assembly: FYIDataAccessShadow, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// MVID: 06F8FB2A-B7D0-40D9-9845-797BAFC936E9
// Assembly location: C:\Users\rames\OneDrive\Desktop\PayPalIPNHandler\FYIDataAccessShadow.dll
...
public class FYIDataAccessShadow
{
  ...
  public int UpdateFYIMessageOpenedDateTime(string PXID, DateTime OpenedDateTime)
  {
    int num = 0;
    try
    {
      ...
      oleDbCommand.Parameters.Add(oleDbParameter1);
      OleDbParameter oleDbParameter2 = new OleDbParameter("@openeddatetime", OleDbType.DBTimeStamp);
      oleDbParameter2.Value = (object) OpenedDateTime;
      oleDbCommand.Parameters.Add(oleDbParameter2);
      if (dbConnection.State == ConnectionState.Closed)
        dbConnection.Open();
      num = oleDbCommand.ExecuteNonQuery();
  ...
  private OleDbConnection GetDBConnection()
  {
    if (this.m_Connection == null)
      this.m_Connection = new OleDbConnection(ConfigurationSettings.AppSettings["SIMPLYFYI_Shadow_ConnectionString"]);
