...
// Type: Utils.OLClientWS.GetBaseResourceUrlCompletedEventArgs
...
public class GetBaseResourceUrlCompletedEventArgs : AsyncCompletedEventArgs
{
  private object[] results;

  internal GetBaseResourceUrlCompletedEventArgs(
    object[] results,
    Exception exception,
    bool cancelled,
    object userState)
