...
// Type: Utils.OLClientWS.GetChoicesFieldValuesCompletedEventHandler
...
public delegate void GetChoicesFieldValuesCompletedEventHandler(
  object sender,
  GetChoicesFieldValuesCompletedEventArgs e);
