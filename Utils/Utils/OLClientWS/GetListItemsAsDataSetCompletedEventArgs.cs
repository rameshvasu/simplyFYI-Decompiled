...
// Type: Utils.OLClientWS.GetListItemsAsDataSetCompletedEventArgs
...
[DebuggerStepThrough]
public class GetListItemsAsDataSetCompletedEventArgs : AsyncCompletedEventArgs
{
  private object[] results;

  internal GetListItemsAsDataSetCompletedEventArgs(
    object[] results,
    Exception exception,
    bool cancelled,
    object userState)
