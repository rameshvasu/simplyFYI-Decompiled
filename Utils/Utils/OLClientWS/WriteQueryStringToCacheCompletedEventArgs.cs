...
// Type: Utils.OLClientWS.WriteQueryStringToCacheCompletedEventArgs
...
[DebuggerStepThrough]
public class WriteQueryStringToCacheCompletedEventArgs : AsyncCompletedEventArgs
{
  private object[] results;

  internal WriteQueryStringToCacheCompletedEventArgs(
    object[] results,
    Exception exception,
    bool cancelled,
    object userState)
