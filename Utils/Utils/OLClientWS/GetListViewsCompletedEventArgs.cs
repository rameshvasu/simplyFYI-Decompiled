...
// Type: Utils.OLClientWS.GetListViewsCompletedEventArgs
...
public class GetListViewsCompletedEventArgs : AsyncCompletedEventArgs
{
  private object[] results;

  internal GetListViewsCompletedEventArgs(
    object[] results,
    Exception exception,
    bool cancelled,
    object userState)
  ...
  public OLView[] Result
  {
    get
    {
      this.RaiseExceptionIfNecessary();
      return (OLView[]) this.results[0];
    }
  }
}
