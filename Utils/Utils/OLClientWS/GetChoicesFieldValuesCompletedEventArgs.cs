...
// Type: Utils.OLClientWS.GetChoicesFieldValuesCompletedEventArgs
...
[DebuggerStepThrough]
public class GetChoicesFieldValuesCompletedEventArgs : AsyncCompletedEventArgs
{
  private object[] results;

  internal GetChoicesFieldValuesCompletedEventArgs(
    object[] results,
    Exception exception,
    bool cancelled,
    object userState)
