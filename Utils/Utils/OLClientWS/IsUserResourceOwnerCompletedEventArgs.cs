...
// Type: Utils.OLClientWS.IsUserResourceOwnerCompletedEventArgs
...
public class IsUserResourceOwnerCompletedEventArgs : AsyncCompletedEventArgs
{
  private object[] results;

  internal IsUserResourceOwnerCompletedEventArgs(
    object[] results,
    Exception exception,
    bool cancelled,
    object userState)
